                        ...
                        <div class="listjs-table" id="customerList">
                            <div class="row g-4 mb-3">
                                <div class="col-sm-auto">
                                    <div>
                                        <a href="{{ route('admins.publishers.addPublishers') }}"><button type="button"
                                ...
                                <table class="table align-middle table-nowrap" id="customerTable">
                                    <thead class="table-light">
                                        <tr>
                                            ...
                                            <th scope="sort">Tên nhà xuất bản</th>
                                        ...
                                        @foreach ($publishers as $key => $value)
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a href="{{ route('admins.publishers.editPublishers', $value->id) }}"
                            ...
                            <div class="d-flex justify-content-end">
                                <div class="pagination-wrap hstack gap-2">
                                    ...
                                    @else
                                        <a class="page-item pagination-prev" href="{{ $publishers->previousPageUrl() }}">
                                            Previous
                                        </a>
                                    @endif
                                    ...
                                    <ul class="pagination listjs-pagination mb-0">
                                        @if ($publishers->currentPage() > 1)
                                            <li class="page-item">
                                                <a class="page-link" href="{{ $publishers->url(1) }}">1</a>
                                            </li>
                                            @if ($publishers->currentPage() > 2)
                                        ...
                                        <li class="page-item active">
                                            <a class="page-link"
                                                href="javascript:void(0);">{{ $publishers->currentPage() }}</a>
                                        </li>

                                        @if ($publishers->currentPage() < $publishers->lastPage() - 1)
                                            <li class="page-item disabled"><span class="page-link">...</span></li>
                                        @endif
                                        ...
                                        @if ($publishers->currentPage() < $publishers->lastPage())
                                            <li class="page-item">
                                                <a class="page-link"
                                                    href="{{ $publishers->url($publishers->lastPage()) }}">{{ $publishers->lastPage() }}</a>
                                            </li>
                                        @endif
                                    </ul>

                                    @if ($publishers->hasMorePages())
                                        <a class="page-item pagination-next" href="{{ $publishers->nextPageUrl() }}">
                                            Next
                                        </a>
                                    @else
...
@push('scripts')
    <script>
        ...
        deleteModel.addEventListener('show.bs.modal', function(event) {
            ...
            formDelete.setAttribute('action', '{{ route('admins.publishers.deletePublishers') }}?idPublisher=' + id)
