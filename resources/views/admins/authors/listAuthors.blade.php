                        ...
                        <div class="listjs-table" id="customerList">
                            <div class="row g-4 mb-3">
                                <div class="col-sm-auto">
                                    <div>
                                        <a href="{{ route('admins.authors.addAuthors') }}"><button type="button"
                                        ...
                                        @foreach ($authors as $key => $value)
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a href="{{ route('admins.authors.editAuthors', $value->id) }}"
                            ...
                            <div class="d-flex justify-content-end">
                                <div class="pagination-wrap hstack gap-2">
                                    ...
                                    @else
                                        <a class="page-item pagination-prev" href="{{ $authors->previousPageUrl() }}">
                                            Previous
                                        </a>
                                    @endif
                                    ...
                                    <ul class="pagination listjs-pagination mb-0">
                                        @if ($authors->currentPage() > 1)
                                            <li class="page-item">
                                                <a class="page-link" href="{{ $authors->url(1) }}">1</a>
                                            </li>
                                        ...
                                        <li class="page-item active">
                                            <a class="page-link"
                                                href="javascript:void(0);">{{ $authors->currentPage() }}</a>
                                        </li>
                                        ...
                                        @if ($authors->currentPage() < $authors->lastPage())
                                            <li class="page-item">
                                                <a class="page-link"
                                                    href="{{ $authors->url($authors->lastPage()) }}">{{ $authors->lastPage() }}</a>
                                            </li>
                                        @endif
                                    </ul>

                                    @if ($authors->hasMorePages())
                                        <a class="page-item pagination-next" href="{{ $authors->nextPageUrl() }}">
                                            Next
                                        </a>
                                    @else
...
@push('scripts')
    <script>
        ...
        deleteModel.addEventListener('show.bs.modal', function(event) {
            ...
            formDelete.setAttribute('action', '{{ route('admins.authors.deleteAuthors') }}?idAuthor=' + id)
