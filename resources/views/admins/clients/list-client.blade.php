    ...
    <div class="container">
        <div class="row">
                        ...
                        <ul class="card-meta list-inline">
                            <li class="list-inline-item">
                                <a href="author-single.html" class="card-meta-author">
                                    <img src="{{ asset('clients/images/john-doe.jpg') }}">
            ...
            <div class="col-lg-4 mb-5">
                ...
                <article class="card mb-4">
                    <div class="card-body d-flex">
                        <img class="card-img-sm" src="{{ asset('clients/images/post/post-3.jpg') }}">
                        <div class="ml-3">
                ...
                <article class="card mb-4">
                    <div class="card-body d-flex">
                        <img class="card-img-sm" src="{{ asset('clients/images/post/post-2.jpg') }}">
                        <div class="ml-3">
                ...
                <article class="card mb-4">
                    <div class="card-body d-flex">
                        <img class="card-img-sm" src="{{ asset('clients/images/post/post-4.jpg') }}">
                        <div class="ml-3">
            ...
            <div class="col-lg-4 mb-5">
                ...
                <article class="card">
                    <div class="post-slider slider-sm">
                        <img src="{{ asset('clients/images/post/post-5.jpg') }}" class="card-img-top" alt="post-thumb">
                    </div>
                    <div class="card-body">
                        ...
                        <ul class="card-meta list-inline">
                            <li class="list-inline-item">
                                <a href="author-single.html" class="card-meta-author">
                                    <img src="{{ asset('clients/images/kate-stone.jpg') }}" alt="Kate Stone">
        ...
        <div class="row justify-content-center">
            <div class="col-lg-8  mb-5 mb-lg-0">
                ...
                <article class="card mb-4">
                    <div class="post-slider">
                        <img src="{{ asset('clients/images/post/post-10.jpg') }}" class="card-img-top" alt="post-thumb">
                        <img src="{{ asset('clients/images/post/post-1.jpg') }}" class="card-img-top" alt="post-thumb">
                    </div>
                    <div class="card-body">
                ...
                <article class="card mb-4">
                    <div class="post-slider">
                        <img src="{{ asset('clients/images/post/post-3.jpg') }}" class="card-img-top" alt="post-thumb">
                    </div>
                    <div class="card-body">
                ...
                <article class="card mb-4">
                    <div class="post-slider">
                        <img src="{{ asset('clients/images/post/post-7.jpg') }}" class="card-img-top" alt="post-thumb">
                    </div>
                ...
                <article class="card mb-4">
                    <div class="post-slider">
                        <img src="{{ asset('clients/images/post/post-8.jpg') }}" class="card-img-top" alt="post-thumb">
                        <img src="{{ asset('') }}clients/images/post/post-9.jpg" class="card-img-top" alt="post-thumb">
                    </div>
                    <div class="card-body">
                        <h3 class="mb-3"><a class="post-title" href="post-details.html">How To Make Cupcakes and
                                Cashmere Recipe At Home</a></h3>
            ...
            <aside class="col-lg-4 sidebar-home">
                ...
                <div class="widget widget-about">
                    ...
                    <img class="img-fluid" src="{{ asset('clients/images/author.jpg') }}" alt="Themefisher">
                ...
                <!-- Promotion -->
                <div class="promotion">
                    <img src="{{ asset('clients/images/promotion.jpg') }}" class="img-fluid w-100">
                ...
                <div class="widget widget-author">
                    ...
                    <div class="media align-items-center">
                        <div class="mr-3">
                            <img class="widget-author-image" src="{{ asset('clients/images/john-doe.jpg') }}">
                        </div>
                    ...
                    <div class="media align-items-center">
                        <div class="mr-3">
                            <img class="widget-author-image" src="{{ asset('clients/images/kate-stone.jpg') }}">
                        </div>
                        <div class="media-body">
                    ...
                    <div class="media align-items-center">
                        <div class="mr-3">
                            <img class="widget-author-image" src="{{ asset('clients/images/john-doe.jpg') }}" alt="John Doe">
                        </div>
                        <div class="media-body">
                ...
                <div class="widget">
                    ...
                    <article class="widget-card">
                        <div class="d-flex">
                            <img class="card-img-sm" src="{{ asset('clients/images/post/post-10.jpg') }}">
                            <div class="ml-3">
                    ...
                    <article class="widget-card">
                        <div class="d-flex">
                            <img class="card-img-sm" src="{{ asset('clients/images/post/post-7.jpg') }}">
                            <div class="ml-3">
                                <h5><a class="post-title" href="post-details.html">Advice From a Twenty Something</a>
                                </h5>
                                <ul class="card-meta list-inline mb-0">
