...
<body>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="text-center mt-sm-5 mb-4 text-white-50">
                            <div>
                                <a href="{{ route('clients.index') }}" class="d-inline-block auth-logo">
                                    <img src="{{ asset('admins/assets/images/logo-light.png') }}" alt=""
                                        height="20">
                                </a>
                            </div>
                            <p class="mt-3 fs-15 fw-medium">Thành Viên Vip</p>
                        </div>
                    </div>
                </div>
                <!-- end row -->
    ...
    <!-- particles js -->
    <script src="{{ asset('admins/assets/libs/particles.js/particles.js') }}"></script>
    <!-- particles app js -->
    <script src="{{ asset('admins/assets/js/pages/particles.app.js') }}"></script>
    <!-- password-addon init -->
