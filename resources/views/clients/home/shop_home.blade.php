...
<div class="container-fluid pt-5">
                ...
                <div class="card product-item border-0 mb-4">
                    <a href="{{ route('clients.productDetails', ['idProduct' => $value->id]) }}"
                        ...
                        <div
                            ...
                            <img class="img-fluid w-100" src="{{ Storage::url($value->image) }}" alt="{{ $value->name }}">
                        </div>
                    </a>
                    <div class="card-body border-left border-right text-center p-0 pt-4 pb-3">
                        ...
                        <div class="d-flex justify-content-center">
                            ...
                            <h6 class="text-muted ml-2"><del>{{ number_format($value->price, 0, ',', '.') }}đ</del></h6>
                        </div>
                    </div>
    ...
    <div class="container-fluid pt-5">
        <div class="text-center mb-4">
            <h2 class="section-title px-5"><span class="px-2">Sản Phẩm tiêu biểu</span></h2>
        </div>
        <div class="row px-xl-5 pb-3">
            @foreach ($products as $key => $value)
                <div class="col-lg-3 col-md-6 col-sm-12 pb-1">
                    <div class="card product-item border-0 mb-4">
                        <a href="{{ route('clients.productDetails', ['idProduct' => $value->id]) }}"
                            ...
                            <div
                                class="card-header product-img position-relative overflow-hidden bg-transparent border p-0">
                                <img class="img-fluid w-100" src="{{ asset($value->image) }}" alt="{{ $value->name }}">
                            </div>
                        </a>
                        <div class="card-body border-left border-right text-center p-0 pt-4 pb-3">
                            <h6 class="text-truncate mb-3">{{ $value->name }}</h6>
